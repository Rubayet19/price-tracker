...
const Testimonial = () => {
  return (
    <section
      ...
      id="testimonials"
    >
      <div className="bg-[radial-gradient(45rem_50rem_at_top,theme(colors.base-300),theme(colors.base-100))] absolute inset-0 -z-10 opacity-20" />
      ...
      <div className="mx-auto max-w-2xl lg:max-w-5xl">
        <figure className="mt-10">
          <div className="flex flex-col items-center gap-12 lg:flex-row">
            ...
            <div>
              <blockquote className="text-base-content text-xl leading-8 font-medium sm:text-2xl sm:leading-10">
