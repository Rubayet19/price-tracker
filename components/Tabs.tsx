...
const Tabs = () => {
  ...
  return (
    <section className="mx-auto max-w-lg space-y-4">
      {/* TAB HEADER */}
      <div
        className="bg-base-200 grid rounded-xl p-1"
      ...
      >
        {tabs.map((tab) => (
          <a
            key={tab.id}
            role="tab"
            className={`flex cursor-pointer items-center justify-center gap-2 rounded-lg py-2 text-sm font-medium select-none ${
              activeTab === tab.id
