    ...
    <Transition appear show={isModalOpen} as={Fragment}>
      ...
      >
        <Transition.Child
          ...
          leaveTo="opacity-0"
        >
          <div className="bg-neutral-focus bg-opacity-50 fixed inset-0" />
        </Transition.Child>
        ...
        <div className="fixed inset-0 overflow-y-auto">
          <div className="flex min-h-full items-start justify-center overflow-hidden p-2 md:items-center">
            ...
            >
              <Dialog.Panel className="bg-base-100 relative h-full w-full max-w-3xl transform overflow-visible rounded-xl p-6 text-left align-middle shadow-xl transition-all md:p-8">
