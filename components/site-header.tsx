...
export function SiteHeader() {
  return (
    <header className="sticky top-0 z-20 flex h-(--header-height) shrink-0 items-center gap-2 border-b border-[#0f172a]/10 bg-[#f7f6f3]/95 backdrop-blur">
      <a
        href="#main-content"
        className="sr-only rounded-md bg-white px-3 py-2 text-sm font-semibold text-[#0f172a] focus:not-sr-only focus:absolute focus:left-4 focus:top-2 focus:z-50 focus:outline-none focus:ring-2 focus:ring-[#0f766e]"
      >
        Skip to content
      </a>
